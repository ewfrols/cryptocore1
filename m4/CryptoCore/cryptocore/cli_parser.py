...
def parse_arguments():
    parser = argparse.ArgumentParser(
        description="CryptoCore - Cryptographic toolkit for encryption, decryption and hashing",
        prog="cryptocore"
    )
    ...
    # NEW: Digest command (Sprint 4)
    digest_parser = subparsers.add_parser("dgst", help="Compute message digest (hash)")
